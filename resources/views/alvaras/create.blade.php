                ...
                <form method="POST" action="{{ route('alvaras.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="tipo" value="{{ old('tipo') }}" placeholder="Ex: Alvará dos Bombeiros" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 @error('tipo') border-red-500 @enderror">
